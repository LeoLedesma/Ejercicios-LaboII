...
namespace Ejercicio7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string aux;
            StringBuilder recibosSueldo = new StringBuilder();
            ...
            for (int i = 0; i < cantidadEmpleados; i++)
            {
                ...
                recibosSueldo.AppendLine($"Nombre: {nombre}, Antiguedad: {antiguedad}, valor hora: {valorHora}, importe bruto: {importeBruto}, importe neto: {importeCobrar}.");
            }
            Console.Clear();
